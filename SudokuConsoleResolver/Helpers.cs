namespace SudokuConsoleResolver
{
    ...
    public static class Helpers
    {
        ...
        public static readonly string columnDelimiter = new string(emptySpace, 2) + verticalBar + new string(emptySpace, 2);
        public static readonly string startColumnDelimiter = verticalBar.ToString();
        public static readonly string endColumnDelimiter = new string(emptySpace, 2) + verticalBar;
        public static readonly string numbersDelimiter = new string(emptySpace, 2);
